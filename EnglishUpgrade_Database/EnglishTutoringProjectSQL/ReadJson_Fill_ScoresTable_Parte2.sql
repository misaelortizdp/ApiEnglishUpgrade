...
with(
	"2021" NVARCHAR(MAX) AS JSON
)
CROSS APPLY OPENJSON("2021")
with (  Comprehension			int,
		Fluency					int,
		[Sentence Structure]	int,
		Pronunciation			int,
		Monolingualism			int,
		Spelling				int,
		[Over All English]		int
)

--where Name <> 'Felipe Diaz' and Name <> 'Javier Leon' and Name <> 'Nestor Castaneda'
 -- where Name in ('Felipe Diaz', 'Javier Leon','Nestor Castaneda') 

--and Name in ('Javier Leon') and Name in ('Nestor Castaneda')


--insert into usuarioscores values (12,67)
--insert into usuarioscores values (25,68)
--insert into usuarioscores values (29,69)
